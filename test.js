...
console.log(
  kanaToRoman("シンイチ", "hepburn", { bmp: true, longSound: "latin" })
    .charAt(0)
    .toUpperCase() +
    kanaToRoman("シンイチ", "hepburn", { bmp: true, longSound: "latin" }).slice(
      1
    ),
  kanaToRoman("オオテマチ", "hepburn", { bmp: true, longSound: "latin" }),
  kanaToRoman("ヒガシヤマ", "hepburn", { bmp: true, longSound: "latin" })
);
